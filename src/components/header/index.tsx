...
const Header: React.FC = () => {
  ...
  const handleSignUp = () => {};
  return (
    <header className="flex justify-between items-center bg-[#022422] {bg-transparent} glassmorphism fixed inset-x-0 top-0 text-white xl:px-28 sm:px-10 px-5 py-5 h-20 z-40">
