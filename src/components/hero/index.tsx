...
const Hero: React.FC = () => {
  return (
    ...
    >
      <div className="bg-gradient-to-b from-[#000505]/70 via-[#000505]/75 to-[#010704]/95 xl:px-28 px-10 w-full h-full pb-10 sm:pb-20 md:pb-32 pt-40 md:pt-48 text-white flex flex-col items-center justify-center gap-10">
        <h1
