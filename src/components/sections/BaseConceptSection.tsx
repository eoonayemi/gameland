...
const BaseConceptSection = () => {
  return (
    <section className="bg-gradient-radial from-[#0e7944] via-[#073820] to-[#062d1a]">
      <div className="bg-gradient-to-b from-[#076c3bc8] via-[#161616d4] to-[#161616] xl:px-28 px-5 py-14 sm:py-10 md:py-20 text-white flex flex-col justify-center gap-10 md:gap-20">
